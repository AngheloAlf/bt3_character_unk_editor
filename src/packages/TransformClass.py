class TransformClass:
	...
	def setR3Command(self, command, asOrd = False):
		...
		# TODO: quitar
		# for i in range(4):
		# 	print self.getTransformData(i)
		# print self.getR3Command()
		return True
	...
	def getTransformData(self, charNumb, asOrd = False):
		...
		data = [self.trans[charNumb]] + [self.barras[charNumb]] + [self.aniCam[charNumb]] + [self.aura[charNumb]] + [self.abs[charNumb]]
